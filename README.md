...
| **Run in GitHub Actions** (GitHub‑hosted CI) | **[GitHub Actions](docs/GITHUB-ACTIONS.md)** — add a workflow on `pull_request` that runs the CLI with `SCM_PROVIDER=github`. |
